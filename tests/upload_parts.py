...
def main():
    ...
    parser.add_argument('--stage',default='/tmp/ardui-v2.pre3-frd')
    ...
    if not re.fullmatch(r'/tmp/ardui-v2\.pre[0-9]+-[a-zA-Z0-9-]+',args.stage): raise ValueError('Unexpected stage')
